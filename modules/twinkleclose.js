...
Twinkle.close.callback = function twinklecloseCallback(title, section, noop) {
	...
	Window.addFooterLink('存废讨论设置', 'QW:TW/PREF#close');
	Window.addFooterLink('Twinkle帮助', 'QW:TW/DOC#close');
...
Twinkle.close.callbacks = {
	...
	deleteTalk: function(apiobj) {
		...
		page.setEditSummary('[[QW:CSD#G15|G15]]: ' + '已删页面“' + apiobj.params.title + '”的[[Qiuwen讨论页|讨论页]]');
		page.setChangeTags(Twinkle.changeTags);
		page.deletePage();
	},
